...
public class AddNewTask extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        newDescText = Objects.requireNonNull(getView()).findViewById(R.id.newDescText);
        newDateText = Objects.requireNonNull(getView()).findViewById(R.id.newDateText);
        ...
        newTaskSaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String descText= newDescText.getText().toString();
                String dateText= newDateText.getText().toString();


                if(finalIsUpdate){
                    db.updateTask(bundle.getInt("id"), taskText);
                    db.updateDesc(bundle.getInt("id"),descText);
                    db.updateDate(bundle.getInt("id"),dateText);
                }
                else {
